	...
	private static class Downloader implements Runnable {
		...
		public void run() {
			...
			try {
					...
					Thread bgThread = new Thread(new Runnable() {
						...
						public void run() {
							try {
								...
								System.out.println("IN IO EXCEPTION : "+weblink.getId());
				...
				//e.printStackTrace();
				System.out.println("IN MalformedURLException : "+weblink.getId());

			} catch (URISyntaxException e) {
				System.out.println("IN URISyntaxException : "+weblink.getId());
