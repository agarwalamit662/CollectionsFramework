...
public class ListDemo {
	...
	static void listIteratorDemo() {
		...
		for (ListIterator iterator = list.listIterator(); iterator.hasNext();) {
			System.out.println("iterator.nextIndex main: " + iterator.nextIndex() + ", iterator.next: " + iterator.next());
			if (iterator.nextIndex() == 1) {
				...
				iterator.set("test1");
                System.out.println("iterator.nextIndex1: " + iterator.nextIndex());
                iterator.add("Lod");
                System.out.println("iterator.nextIndex2: " + iterator.nextIndex());
			}
		}
